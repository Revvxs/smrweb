#THIS CODE WAS MADE BY GAME MODDERS
...
print("""
======================================================================
BAN ALL BY GAME MODDERS  
  credit: Viper(Helped With Code)
======================================================================
""")

title_id = input("Enter your PlayFab ID: ")
secret_key = input("Enter Your Playfab Dev Key: ")
